...
#		file.write('\t%-20s & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f \\\\\n' % (
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			...
			helper.get_roundedNumber(results['++']['mm'].fake, results['++']['mm'].fake_err) +
			helper.get_roundedNumber(results['++']['em'].fake, results['++']['em'].fake_err) +
			helper.get_roundedNumber(results['++']['ee'].fake, results['++']['ee'].fake_err) +
			helper.get_roundedNumber(results['--']['mm'].fake, results['--']['mm'].fake_err) +
			helper.get_roundedNumber(results['--']['em'].fake, results['--']['em'].fake_err) +
			helper.get_roundedNumber(results['--']['ee'].fake, results['--']['ee'].fake_err)))
	...
	##//					   npf_em + nfp_em + npf_mm + npf_ee, sqrt(FR->getTotSingleEStat()*FR->getTotSingleEStat() + nSF*nSF*FakeESyst2));
		file.write('\t%-20s &      {--}     & %5s +- %4s & %5s +- %4s &      {--}     & %5s +- %4s & %5s +- %4s \\\\\n' % (
			...
			helper.get_roundedNumber(results['++']['em'].cmid, results['++']['em'].cmid_err) +
			helper.get_roundedNumber(results['++']['ee'].cmid, results['++']['ee'].cmid_err) +
			helper.get_roundedNumber(results['--']['em'].cmid, results['--']['em'].cmid_err) +
			helper.get_roundedNumber(results['--']['ee'].cmid, results['--']['ee'].cmid_err)))
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			(pl.get_processName('rare'),) +
			helper.get_roundedNumber(results['++']['mm'].rare, results['++']['mm'].rare_err) +
			helper.get_roundedNumber(results['++']['em'].rare, results['++']['em'].rare_err) +
			helper.get_roundedNumber(results['++']['ee'].rare, results['++']['ee'].rare_err) +
			helper.get_roundedNumber(results['--']['mm'].rare, results['--']['mm'].rare_err) +
			helper.get_roundedNumber(results['--']['em'].rare, results['--']['em'].rare_err) +
			helper.get_roundedNumber(results['--']['ee'].rare, results['--']['ee'].rare_err)))
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			(pl.get_processName('wz'),) +
			helper.get_roundedNumber(results['++']['mm'].wz, results['++']['mm'].wz_err) +
			helper.get_roundedNumber(results['++']['em'].wz, results['++']['em'].wz_err) +
			helper.get_roundedNumber(results['++']['ee'].wz, results['++']['ee'].wz_err) +
			helper.get_roundedNumber(results['--']['mm'].wz, results['--']['mm'].wz_err) +
			helper.get_roundedNumber(results['--']['em'].wz, results['--']['em'].wz_err) +
			helper.get_roundedNumber(results['--']['ee'].wz, results['--']['ee'].wz_err)))
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
	...
	##//	}
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			('Total background',) +
			helper.get_roundedNumber(results['++']['mm'].tot, results['++']['mm'].tot_err) +
			helper.get_roundedNumber(results['++']['em'].tot, results['++']['em'].tot_err) +
			helper.get_roundedNumber(results['++']['ee'].tot, results['++']['ee'].tot_err) +
			helper.get_roundedNumber(results['--']['mm'].tot, results['--']['mm'].tot_err) +
			helper.get_roundedNumber(results['--']['em'].tot, results['--']['em'].tot_err) +
			helper.get_roundedNumber(results['--']['ee'].tot, results['--']['ee'].tot_err)))
#		file.write('\t%-20s & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f & %5.1f +- %3.1f \\\\\n' % (
...
#			results['--']['ee'].ttw, results['--']['ee'].ttw_err))
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			...
			helper.get_roundedNumber(results['++']['mm'].ttw, math.sqrt(results['++']['mm'].ttw_staterr*results['++']['mm'].ttw_staterr + 0.08*0.08*results['++']['mm'].ttw*results['++']['mm'].ttw)) +
			helper.get_roundedNumber(results['++']['em'].ttw, math.sqrt(results['++']['em'].ttw_staterr*results['++']['em'].ttw_staterr + 0.08*0.08*results['++']['em'].ttw*results['++']['em'].ttw)) +
			helper.get_roundedNumber(results['++']['ee'].ttw, math.sqrt(results['++']['ee'].ttw_staterr*results['++']['ee'].ttw_staterr + 0.08*0.08*results['++']['ee'].ttw*results['++']['ee'].ttw)) +
			helper.get_roundedNumber(results['--']['mm'].ttw, math.sqrt(results['--']['mm'].ttw_staterr*results['--']['mm'].ttw_staterr + 0.08*0.08*results['--']['mm'].ttw*results['--']['mm'].ttw)) +
			helper.get_roundedNumber(results['--']['em'].ttw, math.sqrt(results['--']['em'].ttw_staterr*results['--']['em'].ttw_staterr + 0.08*0.08*results['--']['em'].ttw*results['--']['em'].ttw)) +
			helper.get_roundedNumber(results['--']['ee'].ttw, math.sqrt(results['--']['ee'].ttw_staterr*results['--']['ee'].ttw_staterr + 0.08*0.08*results['--']['ee'].ttw*results['--']['ee'].ttw))))
		file.write('\t%-20s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s & %5s +- %4s \\\\\n' % (
			('Total expected',) +
			helper.get_roundedNumber(results['++']['mm'].tot_exp, results['++']['mm'].tot_exp_err) +
			helper.get_roundedNumber(results['++']['em'].tot_exp, results['++']['em'].tot_exp_err) +
			helper.get_roundedNumber(results['++']['ee'].tot_exp, results['++']['ee'].tot_exp_err) +
			helper.get_roundedNumber(results['--']['mm'].tot_exp, results['--']['mm'].tot_exp_err) +
			helper.get_roundedNumber(results['--']['em'].tot_exp, results['--']['em'].tot_exp_err) +
			helper.get_roundedNumber(results['--']['ee'].tot_exp, results['--']['ee'].tot_exp_err)))
