...
def get_histoBins(var, sel = '') :
		...
		elif var == 'ElPFIso' : histo_settings['nbins'] = 12; histo_settings['min'] = 0.; histo_settings['max'] = 0.6;
		...
		elif var == 'Flavor': histo_settings['nbins'] =  6; histo_settings['min'] = 0.;    histo_settings['max'] = 6.;
