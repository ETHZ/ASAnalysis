...
#		return
		...
		h_top_name   = 'h_top_'   + var + sel.name; histos['top'  ] = self.get_mcHistoFromTree(tree, self.get_samples('Top'   ), var_str, h_top_name  , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_zjets_name = 'h_zjets_' + var + sel.name; histos['zjets'] = self.get_mcHistoFromTree(tree, self.get_samples('DYJets'), var_str, h_zjets_name, settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_wjets_name = 'h_wjets_' + var + sel.name; histos['wjets'] = self.get_mcHistoFromTree(tree, self.get_samples('WJets' ), var_str, h_wjets_name, settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_rare_name  = 'h_rare_'  + var + sel.name; histos['rare' ] = self.get_mcHistoFromTree(tree, self.get_samples('Rare'  ), var_str, h_rare_name , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_wz_name    = 'h_wz_'    + var + sel.name; histos['wz'   ] = self.get_mcHistoFromTree(tree, self.get_samples('WZ'    ), var_str, h_wz_name   , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_ttz_name   = 'h_ttz_'   + var + sel.name; histos['ttz'  ] = self.get_mcHistoFromTree(tree, self.get_samples('TTZ'   ), var_str, h_ttz_name  , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_ttw_name   = 'h_ttw_'   + var + sel.name; histos['ttw'  ] = self.get_mcHistoFromTree(tree, self.get_samples('TTW'   ), var_str, h_ttw_name  , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_ttw_name   = 'h_qcd_'   + var + sel.name; histos['qcd'  ] = self.get_mcHistoFromTree(tree, self.get_samples('QCD'   ), var_str, h_ttw_name  , settings, 'LepSF*PUWeight', sel.get_selectionString())
		h_miss_name  = 'h_miss_'  + var + sel.name; histos['miss' ] = self.get_mcHistoFromTree(tree, missing                   , var_str, h_ttw_name  , settings, 'LepSF*PUWeight', sel.get_selectionString())
