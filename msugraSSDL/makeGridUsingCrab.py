...
parser.add_option("-q", "--queue",    dest="queue",    default="all.q",   type="string", help="LSF queue to use (can be changed in .cfg file)")
...
[USER]
script_exe = {out}.sh
additional_input_files = /shome/mdunser/workspace/CMSSW_4_2_8/src/DiLeptonAnalysis/NTupleProducer/macros/msugraSSDL/combine,{wsp}
copy_data = 1
