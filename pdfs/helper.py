...
def removeSlices(histo, xrange, yrange):
	for x in xrange:
		for y in yrange:
			if y == x - 200 or y == x - 225:
				histo.SetBinContent(histo.FindBin(x, y),0.)

def getModelText(model):
	texts = []
	if model == 'T1tttt' or model=='T1tttt3rdVeto':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow t#bar{t}#tilde{#chi}^{0}_{1}')
		texts.append('')
		##texts.append('m_{#tilde{#chi}_{1}^{0}} = 50 GeV')
	if model == 'T5tttt':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow t#tilde{t}, #tilde{t}#rightarrow #bar{t}#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{0}} = 50 GeV')
	if model == 'T6ttWW':
		texts.append('pp#rightarrow#tilde{b}#tilde{b}, #tilde{b}#rightarrow t#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{0}} = 50 GeV')
	if model == 'T6ttWWx08':
		texts.append('pp#rightarrow#tilde{b}#tilde{b}, #tilde{b}#rightarrow t#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{0}}/m_{#tilde{#chi}_{1}^{#pm}} = 0.8')
	if model == 'T6ttWWx05':
		texts.append('pp#rightarrow#tilde{b}#tilde{b}, #tilde{b}#rightarrow t#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{0}}/m_{#tilde{#chi}_{1}^{#pm}} = 0.5')
	if model == 'T7btWmChi300':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow b#tilde{b}, #tilde{b}#rightarrow t#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{#pm}} = 300 GeV')
		texts.append('m_{#tilde{#chi}_{1}^{0}} = 50 GeV')
	if model == 'T7btWmChi150':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow b#tilde{b}, #tilde{b}#rightarrow t#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{#pm}} = 150 GeV')
		texts.append('m_{#tilde{#chi}_{1}^{0}} = 50 GeV')
	if model == 'T5VV':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow q#bar{q}#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{#pm}} = 0.5m_{#tilde{#chi}^{0}_{1}} + 0.5m_{#tilde{g}}')
	if model == 'T5lnu':
		texts.append('pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow q#bar{q}#tilde{#chi}_{1}^{#pm}, #tilde{#chi}_{1}^{#pm}#rightarrow W#tilde{#chi}^{0}_{1}')
		texts.append('m_{#tilde{#chi}_{1}^{#pm}} = 0.8m_{#tilde{#chi}^{0}_{1}} + 0.2m_{#tilde{g}}')
	if model == 'T6ttHH':
		texts.append('pp#rightarrow#tilde{t}_{2}#tilde{t}_{2}, #tilde{t}_{2}#rightarrow H#tilde{t}_{1}, #tilde{t}_{1}#rightarrow t#tilde{#chi}^{0}_{1}')
		texts.append('m_{LSP} = #tilde{t}_{1} - 175')
	if model == 'pMSSM':
		texts.append('doens\'t apply')
	...
	##"pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow btW#tilde{#chi}^{0}_{1}",
	##"pp#rightarrow#tilde{g}#tilde{g}, #tilde{g}#rightarrow btW#tilde{#chi}^{0}_{1}",
	##"pp#rightarrow#tilde{b}_{1}#tilde{b}_{1}#kern[-0.6]{#lower[-0.2]{*}}, #tilde{b}_{1}#rightarrow bZ#tilde{#chi}^{0}_{1}",
	##"pp#rightarrow#tilde{b}_{1}#tilde{b}_{1}#kern[-0.6]{#lower[-0.2]{*}}, #tilde{b}_{1}#rightarrow tW#tilde{#chi}^{0}_{1}",
	##"pp#rightarrow#tilde{b}_{1}#tilde{b}_{1}#kern[-0.6]{#lower[-0.2]{*}}, #tilde{b}_{1}#rightarrow tW#tilde{#chi}^{0}_{1}",
	##"pp#rightarrow#tilde{b}_{1}#tilde{b}_{1}#kern[-0.6]{#lower[-0.2]{*}}, #tilde{b}_{1}#rightarrow tW#tilde{#chi}^{0}_{1}"
    
    
	##"m_{#tilde{#chi}_{1}^{0}} = 50 GeV",
	##"m_{#tilde{#chi}_{1}^{0}} = 50 GeV",
	##"m_{#tilde{#chi}_{1}^{#pm}} - m_{#tilde{#chi}_{1}^{0}} = 110 GeV",
	##"m_{#tilde{#chi}_{1}^{0}} = 50 GeV",
	##"m_{#tilde{#chi}_{1}^{0}}/m_{#tilde{#chi}_{1}^{#pm}} = 0.5",
	##"m_{#tilde{#chi}_{1}^{0}}/m_{#tilde{#chi}_{1}^{#pm}} = 0.8"};
...
def getError(n, ngen):
	...
	upper = eff.ClopperPearson(ngen, n, 0.68, True);
	delta = upper - float(n)/float(ngen);
	del eff
...
def drawTopLine(lumi, pbFb):
	...
	elif pbFb =='fb': drawLatex('L_{int.} = %3.2f fb^{-1}' %(lumi/1000.), 0.70, 0.92)
...
def set1DStyle():
	...
	# Margins:
	#### marc marc style1d.SetPadTopMargin(0.05)
	style1d.SetPadTopMargin(0.08)
	style1d.SetPadBottomMargin(0.15)
	style1d.SetPadLeftMargin(0.13)
	#### marc marc style1d.SetPadRightMargin(0.15)
	style1d.SetPadRightMargin(0.18)
