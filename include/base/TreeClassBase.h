...
// Mon Feb 27 14:52:39 2012 by ROOT version 5.27/06b
...
public :
   ...
   Int_t           genInfoPromptFlag[2000];   //[nGenParticles]
   ...
   Int_t           gv_n;
   Float_t         gv_sumPtHi[60];   //[gv_n]
   Float_t         gv_sumPtLo[60];   //[gv_n]
   Int_t           gv_nTkHi[60];   //[gv_n]
   Int_t           gv_nTkLo[60];   //[gv_n]
