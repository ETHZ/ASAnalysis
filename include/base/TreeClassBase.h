...
// Tue Jan 15 18:16:49 2013 by ROOT version 5.27/06b
// from TTree Analysis/ETHZAnalysisTree
// found on file: /scratch/peruzzi/NTupleProducer_42X_MC_28_3_4Cb.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         SCRaw[101];   //[NSuperClusters]
   Float_t         SCPre[101];   //[NSuperClusters]
   Float_t         SCEnergy[101];   //[NSuperClusters]
   Float_t         SCEta[101];   //[NSuperClusters]
   Float_t         SCPhi[101];   //[NSuperClusters]
   Float_t         SCPhiWidth[101];   //[NSuperClusters]
   Float_t         SCEtaWidth[101];   //[NSuperClusters]
   Float_t         SCBrem[101];   //[NSuperClusters]
   Float_t         SCR9[101];   //[NSuperClusters]
   Float_t         SCcrackcorrseed[101];   //[NSuperClusters]
   Float_t         SCcrackcorr[101];   //[NSuperClusters]
   Float_t         SClocalcorrseed[101];   //[NSuperClusters]
   Float_t         SClocalcorr[101];   //[NSuperClusters]
   Float_t         SCcrackcorrseedfactor[101];   //[NSuperClusters]
   Float_t         SClocalcorrseedfactor[101];   //[NSuperClusters]
   Float_t         SCx[101];   //[NSuperClusters]
   Float_t         SCy[101];   //[NSuperClusters]
   Float_t         SCz[101];   //[NSuperClusters]
   Int_t           SCNXtals[101];   //[NSuperClusters]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/scratch/peruzzi/NTupleProducer_42X_MC_28_3_4Cb.root");
      if (!f) {
         f = new TFile("/scratch/peruzzi/NTupleProducer_42X_MC_28_3_4Cb.root");
      }
