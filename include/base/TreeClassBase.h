...
// Thu Aug 16 14:06:26 2012 by ROOT version 5.27/06b
// from TTree Analysis/ETHZAnalysisTree
// found on file: ../test/NTupleProducer_42X_MC_numEvent30.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           Conv_n;
   Bool_t          Conv_validvtx[17];   //[Conv_n]
   Int_t           Conv_ntracks[17];   //[Conv_n]
   Float_t         Conv_chi2_probability[17];   //[Conv_n]
   Float_t         Conv_eoverp[17];   //[Conv_n]
   Float_t         Conv_zofprimvtxfromtrks[17];   //[Conv_n]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../test/NTupleProducer_42X_MC_numEvent30.root");
      if (!f) {
         f = new TFile("../test/NTupleProducer_42X_MC_numEvent30.root");
      }
