...
private:
	void SaveLeptConfs();
	void PrintJetRatios();
	void BSolve (double p, double dp, double ncorr[], double dncorr[], double npair[], double dnpair[]);
	void GetGSFE (double n2j, double nbmul[], double p, double dp, double &alp, double &dalp, double ngs[], double dngs[], double ncorr[], double dncorr[]);
	void PrintChaRatios();
	void PrintDilRatios();
	void PrintAnomEvts();
	void SaveRatioHist();
