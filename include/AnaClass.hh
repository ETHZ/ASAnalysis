...
*****************************************************************************/
	...
	void plotVar(const char* var, const TCut reqs, TTree *tree, TString tag, int nbins, double xmin, double xmax, bool logy = false, double line1x = -999., double line2x = -999.);
