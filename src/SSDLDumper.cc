...
int   SSDLDumper::getClosestJet(int ind, gChannel chan, float jetPtCut, bool doLepCleaning){
...
float SSDLDumper::getClosestJetDR(int ind, gChannel chan, float jetPtCut, bool doLepCleaning){
