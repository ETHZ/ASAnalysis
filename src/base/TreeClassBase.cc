...
const bool TreeClassBase::GetAllByLabel(void) {
    ...
    result &= event->getByLabel( tCAJbTagProbSimpSVHighEff, hCAJbTagProbSimpSVHighEff );
    if ( hCAJbTagProbSimpSVHighEff.isValid() ) CAJbTagProbSimpSVHighEff = *hCAJbTagProbSimpSVHighEff;
    result &= event->getByLabel( tCAJbTagProbSimpSVHighPur, hCAJbTagProbSimpSVHighPur );
    if ( hCAJbTagProbSimpSVHighPur.isValid() ) CAJbTagProbSimpSVHighPur = *hCAJbTagProbSimpSVHighPur;
    result &= event->getByLabel( tCAJbTagProbTkCntHighEff, hCAJbTagProbTkCntHighEff );
    if ( hCAJbTagProbTkCntHighEff.isValid() ) CAJbTagProbTkCntHighEff = *hCAJbTagProbTkCntHighEff;
    result &= event->getByLabel( tCAJbTagProbTkCntHighPur, hCAJbTagProbTkCntHighPur );
    if ( hCAJbTagProbTkCntHighPur.isValid() ) CAJbTagProbTkCntHighPur = *hCAJbTagProbTkCntHighPur;
    ...
    result &= event->getByLabel( tElelectronPFIsoChHad02, hElelectronPFIsoChHad02 );
    if ( hElelectronPFIsoChHad02.isValid() ) ElelectronPFIsoChHad02 = *hElelectronPFIsoChHad02;
    ...
    result &= event->getByLabel( tElelectronPFIsoNHad02, hElelectronPFIsoNHad02 );
    if ( hElelectronPFIsoNHad02.isValid() ) ElelectronPFIsoNHad02 = *hElelectronPFIsoNHad02;
    ...
    result &= event->getByLabel( tElelectronPFIsoPhoton02, hElelectronPFIsoPhoton02 );
    if ( hElelectronPFIsoPhoton02.isValid() ) ElelectronPFIsoPhoton02 = *hElelectronPFIsoPhoton02;
    ...
    result &= event->getByLabel( tElelectronRadPFIsoChHad02, hElelectronRadPFIsoChHad02 );
    if ( hElelectronRadPFIsoChHad02.isValid() ) ElelectronRadPFIsoChHad02 = *hElelectronRadPFIsoChHad02;
    ...
    result &= event->getByLabel( tElelectronRadPFIsoNHad02, hElelectronRadPFIsoNHad02 );
    if ( hElelectronRadPFIsoNHad02.isValid() ) ElelectronRadPFIsoNHad02 = *hElelectronRadPFIsoNHad02;
    ...
    result &= event->getByLabel( tElelectronRadPFIsoPhoton02, hElelectronRadPFIsoPhoton02 );
    if ( hElelectronRadPFIsoPhoton02.isValid() ) ElelectronRadPFIsoPhoton02 = *hElelectronRadPFIsoPhoton02;
    ...
    result &= event->getByLabel( tMumuonPFIsoChHad02, hMumuonPFIsoChHad02 );
    if ( hMumuonPFIsoChHad02.isValid() ) MumuonPFIsoChHad02 = *hMumuonPFIsoChHad02;
    ...
    result &= event->getByLabel( tMumuonPFIsoNHad02, hMumuonPFIsoNHad02 );
    if ( hMumuonPFIsoNHad02.isValid() ) MumuonPFIsoNHad02 = *hMumuonPFIsoNHad02;
    ...
    result &= event->getByLabel( tMumuonPFIsoPhoton02, hMumuonPFIsoPhoton02 );
    if ( hMumuonPFIsoPhoton02.isValid() ) MumuonPFIsoPhoton02 = *hMumuonPFIsoPhoton02;
    ...
    result &= event->getByLabel( tMumuonRadPFIsoChHad02, hMumuonRadPFIsoChHad02 );
    if ( hMumuonRadPFIsoChHad02.isValid() ) MumuonRadPFIsoChHad02 = *hMumuonRadPFIsoChHad02;
    ...
    result &= event->getByLabel( tMumuonRadPFIsoNHad02, hMumuonRadPFIsoNHad02 );
    if ( hMumuonRadPFIsoNHad02.isValid() ) MumuonRadPFIsoNHad02 = *hMumuonRadPFIsoNHad02;
    ...
    result &= event->getByLabel( tMumuonRadPFIsoPhoton02, hMumuonRadPFIsoPhoton02 );
    if ( hMumuonRadPFIsoPhoton02.isValid() ) MumuonRadPFIsoPhoton02 = *hMumuonRadPFIsoPhoton02;
    ...
    result &= event->getByLabel( tPF2PAT2JbTagProbSimpSVHighEff, hPF2PAT2JbTagProbSimpSVHighEff );
    if ( hPF2PAT2JbTagProbSimpSVHighEff.isValid() ) PF2PAT2JbTagProbSimpSVHighEff = *hPF2PAT2JbTagProbSimpSVHighEff;
    result &= event->getByLabel( tPF2PAT2JbTagProbSimpSVHighPur, hPF2PAT2JbTagProbSimpSVHighPur );
    if ( hPF2PAT2JbTagProbSimpSVHighPur.isValid() ) PF2PAT2JbTagProbSimpSVHighPur = *hPF2PAT2JbTagProbSimpSVHighPur;
    result &= event->getByLabel( tPF2PAT2JbTagProbTkCntHighEff, hPF2PAT2JbTagProbTkCntHighEff );
    if ( hPF2PAT2JbTagProbTkCntHighEff.isValid() ) PF2PAT2JbTagProbTkCntHighEff = *hPF2PAT2JbTagProbTkCntHighEff;
    result &= event->getByLabel( tPF2PAT2JbTagProbTkCntHighPur, hPF2PAT2JbTagProbTkCntHighPur );
    if ( hPF2PAT2JbTagProbTkCntHighPur.isValid() ) PF2PAT2JbTagProbTkCntHighPur = *hPF2PAT2JbTagProbTkCntHighPur;
    ...
    result &= event->getByLabel( tPF2PAT3JbTagProbSimpSVHighEff, hPF2PAT3JbTagProbSimpSVHighEff );
    if ( hPF2PAT3JbTagProbSimpSVHighEff.isValid() ) PF2PAT3JbTagProbSimpSVHighEff = *hPF2PAT3JbTagProbSimpSVHighEff;
    result &= event->getByLabel( tPF2PAT3JbTagProbSimpSVHighPur, hPF2PAT3JbTagProbSimpSVHighPur );
    if ( hPF2PAT3JbTagProbSimpSVHighPur.isValid() ) PF2PAT3JbTagProbSimpSVHighPur = *hPF2PAT3JbTagProbSimpSVHighPur;
    result &= event->getByLabel( tPF2PAT3JbTagProbTkCntHighEff, hPF2PAT3JbTagProbTkCntHighEff );
    if ( hPF2PAT3JbTagProbTkCntHighEff.isValid() ) PF2PAT3JbTagProbTkCntHighEff = *hPF2PAT3JbTagProbTkCntHighEff;
    result &= event->getByLabel( tPF2PAT3JbTagProbTkCntHighPur, hPF2PAT3JbTagProbTkCntHighPur );
    if ( hPF2PAT3JbTagProbTkCntHighPur.isValid() ) PF2PAT3JbTagProbTkCntHighPur = *hPF2PAT3JbTagProbTkCntHighPur;
    ...
    result &= event->getByLabel( tPF2PATAntiIsoJbTagProbSimpSVHighEff, hPF2PATAntiIsoJbTagProbSimpSVHighEff );
    if ( hPF2PATAntiIsoJbTagProbSimpSVHighEff.isValid() ) PF2PATAntiIsoJbTagProbSimpSVHighEff = *hPF2PATAntiIsoJbTagProbSimpSVHighEff;
    result &= event->getByLabel( tPF2PATAntiIsoJbTagProbSimpSVHighPur, hPF2PATAntiIsoJbTagProbSimpSVHighPur );
    if ( hPF2PATAntiIsoJbTagProbSimpSVHighPur.isValid() ) PF2PATAntiIsoJbTagProbSimpSVHighPur = *hPF2PATAntiIsoJbTagProbSimpSVHighPur;
    result &= event->getByLabel( tPF2PATAntiIsoJbTagProbTkCntHighEff, hPF2PATAntiIsoJbTagProbTkCntHighEff );
    if ( hPF2PATAntiIsoJbTagProbTkCntHighEff.isValid() ) PF2PATAntiIsoJbTagProbTkCntHighEff = *hPF2PATAntiIsoJbTagProbTkCntHighEff;
    result &= event->getByLabel( tPF2PATAntiIsoJbTagProbTkCntHighPur, hPF2PATAntiIsoJbTagProbTkCntHighPur );
    if ( hPF2PATAntiIsoJbTagProbTkCntHighPur.isValid() ) PF2PATAntiIsoJbTagProbTkCntHighPur = *hPF2PATAntiIsoJbTagProbTkCntHighPur;
    ...
    result &= event->getByLabel( tgenInfoDa1, hgenInfoDa1 );
    if ( hgenInfoDa1.isValid() ) genInfoDa1 = *hgenInfoDa1;
    result &= event->getByLabel( tgenInfoDa2, hgenInfoDa2 );
    if ( hgenInfoDa2.isValid() ) genInfoDa2 = *hgenInfoDa2;
    ...
    result &= event->getByLabel( tgenInfoMass, hgenInfoMass );
    if ( hgenInfoMass.isValid() ) genInfoMass = *hgenInfoMass;
    result &= event->getByLabel( tgenInfoMo1, hgenInfoMo1 );
    if ( hgenInfoMo1.isValid() ) genInfoMo1 = *hgenInfoMo1;
    result &= event->getByLabel( tgenInfoMo1Pt, hgenInfoMo1Pt );
    if ( hgenInfoMo1Pt.isValid() ) genInfoMo1Pt = *hgenInfoMo1Pt;
    result &= event->getByLabel( tgenInfoMo2, hgenInfoMo2 );
    if ( hgenInfoMo2.isValid() ) genInfoMo2 = *hgenInfoMo2;
    result &= event->getByLabel( tgenInfoMo2Pt, hgenInfoMo2Pt );
    if ( hgenInfoMo2Pt.isValid() ) genInfoMo2Pt = *hgenInfoMo2Pt;
    result &= event->getByLabel( tgenInfoMoIndex, hgenInfoMoIndex );
    if ( hgenInfoMoIndex.isValid() ) genInfoMoIndex = *hgenInfoMoIndex;
    result &= event->getByLabel( tgenInfoNDa, hgenInfoNDa );
    if ( hgenInfoNDa.isValid() ) genInfoNDa = *hgenInfoNDa;
...
void TreeClassBase::Init(void)
{
    ...
    tCAJbTagProbSimpSVHighEff  = edm::InputTag("analyze","CAJbTagProbSimpSVHighEff");
    tCAJbTagProbSimpSVHighPur  = edm::InputTag("analyze","CAJbTagProbSimpSVHighPur");
    tCAJbTagProbTkCntHighEff   = edm::InputTag("analyze","CAJbTagProbTkCntHighEff");
    tCAJbTagProbTkCntHighPur   = edm::InputTag("analyze","CAJbTagProbTkCntHighPur");
    ...
    tElelectronPFIsoChHad02    = edm::InputTag("analyze","ElelectronPFIsoChHad02");
    ...
    tElelectronPFIsoNHad02     = edm::InputTag("analyze","ElelectronPFIsoNHad02");
    ...
    tElelectronPFIsoPhoton02   = edm::InputTag("analyze","ElelectronPFIsoPhoton02");
    ...
    tElelectronRadPFIsoChHad02 = edm::InputTag("analyze","ElelectronRadPFIsoChHad02");
    ...
    tElelectronRadPFIsoNHad02  = edm::InputTag("analyze","ElelectronRadPFIsoNHad02");
    ...
    tElelectronRadPFIsoPhoton02 = edm::InputTag("analyze","ElelectronRadPFIsoPhoton02");
    ...
    tMumuonRadPFIsoChHad02     = edm::InputTag("analyze","MumuonRadPFIsoChHad02");
    ...
    tMumuonRadPFIsoNHad02      = edm::InputTag("analyze","MumuonRadPFIsoNHad02");
    ...
    tMumuonRadPFIsoPhoton02    = edm::InputTag("analyze","MumuonRadPFIsoPhoton02");
    ...
    tPF2PAT2JbTagProbSimpSVHighEff = edm::InputTag("analyze","PF2PAT2JbTagProbSimpSVHighEff");
    tPF2PAT2JbTagProbSimpSVHighPur = edm::InputTag("analyze","PF2PAT2JbTagProbSimpSVHighPur");
    tPF2PAT2JbTagProbTkCntHighEff = edm::InputTag("analyze","PF2PAT2JbTagProbTkCntHighEff");
    tPF2PAT2JbTagProbTkCntHighPur = edm::InputTag("analyze","PF2PAT2JbTagProbTkCntHighPur");
    ...
    tPF2PAT3JbTagProbSimpSVHighEff = edm::InputTag("analyze","PF2PAT3JbTagProbSimpSVHighEff");
    tPF2PAT3JbTagProbSimpSVHighPur = edm::InputTag("analyze","PF2PAT3JbTagProbSimpSVHighPur");
    tPF2PAT3JbTagProbTkCntHighEff = edm::InputTag("analyze","PF2PAT3JbTagProbTkCntHighEff");
    tPF2PAT3JbTagProbTkCntHighPur = edm::InputTag("analyze","PF2PAT3JbTagProbTkCntHighPur");
    ...
    tPF2PATAntiIsoJbTagProbSimpSVHighEff = edm::InputTag("analyze","PF2PATAntiIsoJbTagProbSimpSVHighEff");
    tPF2PATAntiIsoJbTagProbSimpSVHighPur = edm::InputTag("analyze","PF2PATAntiIsoJbTagProbSimpSVHighPur");
    tPF2PATAntiIsoJbTagProbTkCntHighEff = edm::InputTag("analyze","PF2PATAntiIsoJbTagProbTkCntHighEff");
    tPF2PATAntiIsoJbTagProbTkCntHighPur = edm::InputTag("analyze","PF2PATAntiIsoJbTagProbTkCntHighPur");
    ...
    tgenInfoDa1                = edm::InputTag("analyze","genInfoDa1");
    tgenInfoDa2                = edm::InputTag("analyze","genInfoDa2");
    ...
    tgenInfoMass               = edm::InputTag("analyze","genInfoMass");
    tgenInfoMo1                = edm::InputTag("analyze","genInfoMo1");
    tgenInfoMo1Pt              = edm::InputTag("analyze","genInfoMo1Pt");
    tgenInfoMo2                = edm::InputTag("analyze","genInfoMo2");
    tgenInfoMo2Pt              = edm::InputTag("analyze","genInfoMo2Pt");
    tgenInfoMoIndex            = edm::InputTag("analyze","genInfoMoIndex");
    tgenInfoNDa                = edm::InputTag("analyze","genInfoNDa");
