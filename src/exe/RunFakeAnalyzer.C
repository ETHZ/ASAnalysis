...
void usage( int status = 0 ) {
	cout << "Usage: RunFakeAnalyzer [-o outfile] [-s] [-v verbose] [-m maxevents] [-e filleff] [-j JSON] [-p pthat] [-l] [-x data PU file] [-y MC PU file] [-g GlobalTag] file1 [... filen]" << endl;
	cout << "  where:" << endl;
	cout << "     outfile   is the output file                    " << endl;
	cout << "                default is fakeminitree.root             " << endl;
...
// Default options
	...
	TString outputfile = "fakeminitree.root";
...
// Check arguments
	...
	FakeAnalyzer *tA = new FakeAnalyzer(fileList, isdata, globaltag);
