...
void usage( int status = 0 ) {
	cout << "Usage: RunDiPhotonJetsAnalyzer [-f datamc] [-d dir] [-v verbose] [-p datapileup] [-P MCpileup] [-n MaxEvents] [-j jsonfile] [-l] file1 [... filen]" << endl;
	cout << "  where:" << endl;
...
// Default options
	...
	DiPhotonJetsAnalyzer *tA = new DiPhotonJetsAnalyzer(theChain,dataType);
