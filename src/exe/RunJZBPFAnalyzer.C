...
void usage( int status = 0 ) {
  cout << "Usage: RunJZBPFAnalyzer [-o filename] [-v verbose] [-n maxEvents] [-j JSON] [-t type] [-c] [-l] [-p data_PileUp] [-P mc_PileUP] file1 [... filen]" << endl;
  cout << "  where:" << endl;
...
int main(int argc, char* argv[]) {
  ...
  JZBPFAnalyzer *tA = new JZBPFAnalyzer(theChain,type,fullCleaning);
